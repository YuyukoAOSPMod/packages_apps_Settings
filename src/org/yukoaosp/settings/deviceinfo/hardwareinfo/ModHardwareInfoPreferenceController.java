        ...
        if (preference != null) {
            ModHardwareInfoPreference.HardwareInfo[] hardwareInfos = {
                    ...
                    new ModHardwareInfoPreference.HardwareInfo(R.drawable.mod_settings_ic_hardware_info_storage,
                            mContext.getString(R.string.mod_settings_my_device_storage_title), mContext.getString(R.string.mod_settings_my_device_storage_regex, getMemoryStatus()[0], getMemoryStatus()[1])),
