...
public class ModVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "ModVersionDetailPrefCtrl";
    ...
    public ModVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
