...
package org.yukoaosp.settings.deviceinfo.firmwareversion;
...
public class ModDisplayVersionPreferenceController extends BasePreferenceController implements
    ...
    private static final String KEY_MOD_VERSION_PROP = "ro.yuyuko.aospmod.version";

    public ModDisplayVersionPreferenceController(Context context, String key) {
        super(context, key);
