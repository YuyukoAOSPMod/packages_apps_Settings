package org.yukoaosp.settings.preference;
...
public class ModHardwareInfoPreference extends Preference {

    private List<HardwareInfo> mHardwareInfoList;

    public ModHardwareInfoPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    public ModHardwareInfoPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public ModHardwareInfoPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ModHardwareInfoPreference(Context context) {
        this(context, null);
    }

    private void init() {
        setLayoutResource(R.layout.mod_settings_my_device_hardware_info_preference);
    }
...
//            this.mHardwareInfoList = hardwareInfoList;
        ...
        public HardwareInfoVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new HardwareInfoVH(LayoutInflater.from(this.mContext).inflate(R.layout.mod_settings_my_device_hardware_info_item, parent, false));
        }
