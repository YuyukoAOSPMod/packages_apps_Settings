...
import org.yukoaosp.settings.deviceinfo.mydevice.ModMyDeviceFragment;
...
public class DeviceNameWarningDialog extends InstrumentedDialogFragment
    ...
    public static void show(ModMyDeviceFragment host) {
        final FragmentManager manager = host.getActivity().getSupportFragmentManager();
        if (manager.findFragmentByTag(TAG) != null) {
            return;
        }
    ...
    public void onClick(DialogInterface dialog, int which) {
        final ModMyDeviceFragment host = (ModMyDeviceFragment) getTargetFragment();
